...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball practices and games against other schools",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, technique work, and local meets",
    ...
    "Debate Team": {
        "description": "Practice debating, public speaking, and attend competitions",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["henry@mergington.edu", "lucas@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for regional science olympiad events with hands-on projects",
